        ...
        <div class="login">
            ...
            <div class="content">
                <div class="log-on border_insc">
                    ...
                    <form method="post" action="../controllers/authentication.php"> <!-- Form submits to PHP script -->
                        <div>
                        ...
                        <button type="submit" class="log_btn">Log in</button> <!-- Changed to submit button -->
                    </form>
